...
export const adminAPI = {
  ...
  requestPasswordChange: () => api.post("/admin/change-password/request"),

  verifyPasswordChange: (newPassword, otp) =>
    api.post("/admin/change-password/verify", { newPassword, otp }),

  // User
  getTutors: (params = {}) => api.get("/admin/tutors", { params }),
  ...
  approveTutor: (tutorId) => api.patch(`/admin/tutors/${tutorId}/approve`),

  rejectTutor: (tutorId) => api.patch(`/admin/tutors/${tutorId}/reject`),
  ...
  getAdminCourseById: (id) => api.get(`/admin/courses/${id}`),
  ...
  downloadSalesReportPDF: (params = {}) =>
    api.get("/admin/sales-report/download/pdf", {
      params,
      responseType: "blob",
    }),

  downloadSalesReportExcel: (params = {}) =>
    api.get("/admin/sales-report/download/excel", {
      params,
      responseType: "blob",
    }),
  ...
  // Wallet
  getWallet: (params = {}) => api.get("/admin/wallet", { params }),
