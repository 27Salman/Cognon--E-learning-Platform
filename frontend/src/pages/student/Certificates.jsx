...
const Certificates = () => {
  ...
  const fetchCertificates = useCallback(
    async (pageNum = 1, search = "", sort = "latest") => {
      setLoading(true);
      try {
        ...
        {certificates.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm p-16 text-center">
            ...
            <p className="text-gray-400 max-w-sm mx-auto">
              Complete a course and pass the quiz to earn your first
              certificate.
            </p>
          </div>
        ) : (
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl">
        ...
        <div
          className="w-full rounded-xl overflow-hidden shadow-2xl select-none flex"
          style={{
            aspectRatio: "842 / 595",
        ...
        >
          ...
          >
            ...
            >
              ...
              <strong style={{ color: "#334155" }}>{tutorName}</strong> and
              offered through Cognon
            </p>
