...
export default function CourseDetails() {
  ...
  const { currentCourse, loading, catalog, courseError } = useSelector(
    (state) => state.student,
  );
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-20">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-500 text-base leading-relaxed mb-10">
              Sorry for the inconvenience. This course is currently unavailable.
              It may have been removed or unlisted by the instructor.
            </p>
            <button
  ...
  const discountedPrice =
    currentCourse.offerPercentage > 0
      ? Math.round(
          currentCourse.price * (1 - currentCourse.offerPercentage / 100),
        )
      : null;
              ...
              <div className="mb-5">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    ({currentCourse.reviewCount || 0} rating
                    {currentCourse.reviewCount !== 1 ? "s" : ""})
                  </span>
                </div>
                ...
                <div className="mb-8 p-5 bg-white rounded-xl border border-gray-200">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div
                      onClick={() =>
                        navigate(
                          ROUTES.STUDENT_TUTOR_DETAIL.replace(
                            ":tutorId",
                            tutor._id,
                          ),
                        )
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-3">
                        {tutor.totalCourses > 0 && (
                          <span className="flex items-center gap-1">
                            ...
                            {tutor.totalCourses}{" "}
                            {tutor.totalCourses === 1 ? "Course" : "Courses"}
                          </span>
                        )}
                        {tutor.totalStudents > 0 && (
                          <span className="flex items-center gap-1">
                            ...
                            {tutor.totalStudents === 1 ? "Student" : "Students"}
                          </span>
                        )}
                      </div>
                ...
                <div className="space-y-4">
                  {reviews.length > 0 ? (
                    reviews.map((review) => (
                      <div
                        key={review._id}
                        className="p-5 bg-white rounded-xl border border-gray-150 shadow-sm space-y-3"
                      >
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl relative border border-gray-105 transform transition-all scale-100 duration-300">
            ...
            <div className="flex flex-col items-center text-center mt-2">
              <div className="w-16 h-16 rounded-full border-4 border-red-600 flex items-center justify-center mb-4">
                <span className="text-red-600 text-4xl font-light font-serif">
                  i
                </span>
              </div>
              <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm text-gray-600 px-2 mb-6">
                This lesson is locked. Purchase the course to unlock all{" "}
                {lessons.length} lessons.
              </p>
            </div>
            ...
            <div className="bg-emerald-50/50 rounded-xl p-4 border border-emerald-100 mb-6">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-500 font-bold">✓</span> Access
                  to all {lessons.length} video lessons
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  <span className="text-emerald-500 font-bold">✓</span> Learn at
                  your own pace
                </li>
              </ul>
            </div>
