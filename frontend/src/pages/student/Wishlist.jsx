        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {wishlist.map((course) => (
              <div
                key={course._id}
                className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow h-full flex flex-col"
              >
                <div
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-2 mt-auto">
                    ...
                    >
                      ...
                      {actionLoading[course._id] === "carting"
                        ? "Adding..."
                        : "Add to Cart"}
                    </button>
                    <button
