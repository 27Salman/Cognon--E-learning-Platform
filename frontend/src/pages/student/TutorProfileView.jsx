  ...
  useEffect(() => {
    const fetchTutorProfile = async () => {
      ...
      try {
        ...
        const coursesRes = await studentAPI.fetchPublishedCourses({
          tutor: tutorId,
          limit: 100,
        });
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 tracking-tight">
                  More Courses by{" "}
                  <span className="text-purple-600">{tutor.name}</span>
                </h2>
                <p className="text-xs text-gray-500 mt-1">
                  Browse active courses published by this tutor.
                </p>
              </div>
              ...
              {totalCoursePages > 1 && (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() =>
                      setCoursePage((p) =>
                        Math.min(totalCoursePages - 1, p + 1),
                      )
                    }
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 font-medium mt-2">
                        ...
                        {course.totalLessons} Lectures • Beginner
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                      ...
                      <div className="flex items-center gap-1.5">
                        {course.offer &&
                        course.offer.discountedPrice < course.price ? (
                          <>
