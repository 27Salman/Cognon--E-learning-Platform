...
export default function CourseCatalog() {
  ...
  const navigate = useNavigate();
  const { catalog, enrolledCourses, loading } = useSelector(
    (state) => state.student,
  );
  ...
  useEffect(() => {
    ...
    fetch(
      `${import.meta.env.VITE_API_URL || "http://localhost:5000/api"}/categories/public`,
    )
      .then((r) => r.json())
      .then((data) => {
      ...
      <div className="flex-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {inProgress.map((course) => (
                  ...
                  >
                    ...
                    <div className="p-3">
                      <h3 className="font-semibold text-gray-800 text-xs truncate mb-1">
                        {course.title}
                      </h3>
        ...
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            {dynamicCategories.length === 0 && (
              <p className="col-span-4 text-gray-400 text-sm text-center py-4">
          ...
          <div className="bg-[#ede9f8] py-10 px-6">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
                {displayedRecommended.map((c) => (
                  <CourseCardLarge key={c._id} course={c} />
                ))}
              </div>
                ...
                <button
                  onClick={() =>
                    setRecommendedPage((p) =>
                      Math.min(recommendedTotalPages - 1, p + 1),
                    )
                  }
        ...
        {technical.length > 0 && (
          <div className="max-w-7xl mx-auto px-6 py-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
              {technical.map((c) => (
                <CourseCardCompact key={c._id} course={c} />
              ))}
            </div>
          </div>
        )}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex justify-end gap-2 mt-4">
                ...
                <button
                  onClick={() =>
                    setTopRatedPage((p) =>
                      Math.min(topRatedTotalPages - 1, p + 1),
                    )
                  }
