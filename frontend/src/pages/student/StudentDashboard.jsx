...
function StudentCategoryCard({ cat, navigate, catalog }) {
  ...
  return (
    <div
      onClick={() =>
        navigate(`/student/categories?category=${encodeURIComponent(cat)}`)
      }
    ...
    >
      ...
      <div
        className={`absolute -right-16 -top-16 w-32 h-32 rounded-full bg-gradient-to-br ${details.color} opacity-0 group-hover:opacity-40 blur-xl transition-all duration-500 group-hover:scale-150 pointer-events-none`}
      />
...
const StudentDashboard = () => {
  ...
  const { catalog = [], enrolledCourses = [] } = useSelector(
    (state) => state.student,
  );
    ...
    <div className="min-h-screen bg-white pb-16">
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div>
              ...
              <p className="text-gray-550 mb-7 leading-relaxed text-sm lg:text-base max-w-lg">
                Bring learning to life with personalized activities, videos, and
                assessments that motivate students at every step of their
                journey.
              </p>
            </div>
      ...
      <div className="w-full px-6">
              ...
              {enrolledCourses.slice(0, 4).map((course) => (
                ...
                >
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="font-bold text-sm mb-1 line-clamp-2 text-gray-800 hover:text-purple-650 transition">
                        {course.title}
                      </h3>
        ...
        <section className="py-12 bg-gray-50/50 rounded-3xl p-8 border border-gray-100">
          <div
            ref={catTitleRef}
            className="scroll-reveal flex justify-between items-center mb-8"
          >
                ...
                >
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="font-bold text-sm mb-2 line-clamp-2 text-gray-800 group-hover:text-purple-600 transition">
                        {course.title}
                      </h3>
                      <p className="text-xs text-gray-500 mb-3">
                        By {course.tutor?.name}
                        ...
                        {course.offer ? (
                          <>
                            <span className="text-lg font-bold text-purple-600">
                              {course.offer.discountedPrice === 0
                                ? "Free"
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div className="bg-gradient-to-br from-purple-900 to-indigo-950 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="relative z-10 max-w-2xl">
              <span className="text-purple-300 font-bold text-xs uppercase tracking-widest mb-3 block">
              ...
              <p className="text-purple-100 mb-6 text-sm leading-relaxed">
                ...
                Byway. We provide the tools and skills to share what you love,
                build an audience, and earn a sustainable income.
              </p>
              <button
      ...
      <section
        ref={extraInfoRef}
        className="scroll-reveal py-20 bg-gray-50 border-t border-gray-100"
      >
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                ...
                in their fields, and enriching their lives by gaining certified,
                industry-recognized knowledge on Cognon.
              </p>
              <button
                onClick={() => navigate(ROUTES.STUDENT_COURSE_CATALOG)}
      ...
      <section
        id="about"
        ref={aboutRef}
        className="scroll-reveal py-20 bg-gray-50 mt-16 border-y border-gray-100"
      >
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div className="text-center mb-16">
            <p className="text-purple-600 font-bold mb-2 text-xs uppercase tracking-widest">
              About Us
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 leading-relaxed text-sm">
                Install practical, industry-ready web development skills into
                your career and gain access to modern tools, frameworks, and
                real-world projects. Learn how to build responsive websites and
                scalable applications using popular frameworks. We guide you
                through architecture, best practices, and deployment so you can
                focus on building clean, efficient, and production-ready web
                applications.
              </p>
              <p className="text-gray-600 leading-relaxed text-sm">
                Launch high-impact digital marketing strategies and get hands-on
                experience with SEO, social media, paid ads, and content
                marketing. Learn how to reach the right audience, drive
                meaningful traffic, and convert users into loyal customers.
                Start building campaigns based on real data and measurable
                outcomes.
              </p>
            </div>
          </div>
