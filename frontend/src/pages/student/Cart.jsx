          ...
          {loading ? (
            <div className="animate-pulse space-y-4">
              {[...Array(2)].map((_, i) => (
                <div
                  key={i}
                  className="h-24 bg-white rounded-xl border border-gray-200"
                />
              ))}
            </div>
          ) : cart.items.length === 0 ? (
                ...
                {cart.hasUnavailable && (
                  <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-xl">
                    ...
                    <p className="text-sm text-red-700 font-medium">
                      Some courses in your cart are no longer available. Remove
                  ...
                  >
                    {item.course?.thumbnailURL ? (
                      <img
                        ...
                        onClick={() =>
                          navigate(`/student/courses/${item.course._id}`)
                        }
                      />
                    ) : (
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 sticky top-24">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between text-gray-600">
                      <span>
                        Subtotal ({cart.totalItems} course
                        {cart.totalItems !== 1 ? "s" : ""})
                      </span>
