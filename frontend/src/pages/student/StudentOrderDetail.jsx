    ...
    if (order) {
      ...
      if (!withinWindow) {
        setCancelEligibility({
          eligible: false,
          reason: "Refund window has expired (3 days from purchase)",
        });
      } else if (order.paymentStatus !== "completed") {
        setCancelEligibility({
          eligible: false,
          reason: "Order is not eligible for cancellation",
        });
      } else {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <h2 className="font-semibold text-gray-700 mb-4 text-base uppercase tracking-wide">
              Order Information
            </h2>
              ...
              {order.paymentCompletedAt && (
                <div>
                  ...
                  <p className="font-medium text-green-700">
                    {new Date(order.paymentCompletedAt).toLocaleString()}
                  </p>
                </div>
              )}
              <div>
          ...
          {/* Purchased Courses */}
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <h2 className="font-semibold text-gray-700 mb-5 text-base uppercase tracking-wide">
              Purchased Courses
            </h2>
                  ...
                  {item.course?.thumbnailURL ? (
                    <img
                      ...
                      onClick={() =>
                        ...
                        navigate(`/student/courses/${item.course._id}/learn`)
                      }
                    />
                  ) : (
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end">
            <span
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-base font-medium capitalize ${STATUS_COLORS[order.paymentStatus]}`}
            >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4">
            ...
            <p className="text-gray-600 mb-6">
              Cancelling will remove your access to all courses in this order.
              The amount ₹{order.finalAmount.toFixed(2)} will be credited to
              your wallet. Are you sure?
            </p>
