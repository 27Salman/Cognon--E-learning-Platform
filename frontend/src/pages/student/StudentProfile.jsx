...
export default function StudentProfile() {
  ...
  const [formData, setFormData] = useState({
    ...
    profileImage:
      studentInfo?.profileImageURL || studentInfo?.profileImage || null,
  });
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const certCount =
          certData.pagination?.totalCertificates ?? certsList.length;
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        profileImage:
          updatedUser.profileImageURL || updatedUser.profileImage || null,
      });
            ...
            {recentCertificates.length === 0 ? (
              ...
              <div className="space-y-3">
                ...
                {stats.certificates > 3 && (
                  <Link
                    to="/student/certificates"
                    className="block text-center text-sm text-violet-600 font-medium hover:text-violet-700 mt-2"
                  >
