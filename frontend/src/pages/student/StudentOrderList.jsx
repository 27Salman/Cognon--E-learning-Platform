        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left px-6 py-4 font-semibold text-gray-500 uppercase text-xs tracking-wider">
                  Order ID
                </th>
                <th className="text-left px-6 py-4 font-semibold text-gray-500 uppercase text-xs tracking-wider">
                  Course
              ...
              {orders.map((order) => (
                ...
                >
                  ...
                  <td className="px-6 py-5 text-gray-700 max-w-[300px]">
                    {order.courses?.length === 1 ? (
                      <span className="truncate block">
                        {order.courses[0].courseTitle}
                      </span>
                    ) : (
                      <span className="text-gray-500">
                        {order.courses?.length} courses
                      </span>
                    )}
                  </td>
                  ...
                  <td className="px-6 py-5">
                    <span
                      className={`px-3 py-1.5 rounded-full text-sm font-medium capitalize ${STATUS_COLORS[order.paymentStatus]}`}
                    >
                      {order.paymentStatus}
                    </span>
                  </td>
