...
function CategoryCard({ category, navigate }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute -right-16 -top-16 w-32 h-32 rounded-full bg-gradient-to-br ${details.color} opacity-0 group-hover:opacity-30 blur-xl transition-all duration-500 group-hover:scale-150 pointer-events-none z-0`}
      />

      <div className="relative z-10 flex justify-between items-start mb-4">
        <div
          className={`w-12 h-12 rounded-xl border flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-sm ${details.iconColor}`}
        >
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center gap-3 text-xs text-gray-400 mt-2 pt-2 border-t border-gray-50">
          ...
          <span>•</span>
          <span>
            {category.enrollmentsCount}{" "}
            {category.enrollmentsCount === 1 ? "enrollment" : "enrollments"}
          </span>
        </div>
      </div>
    </div>
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE}/api/catalog/courses?limit=300`)
      ...
      .then((res) => {
        ...
        const sortedRatingCourses = [...allCourses].sort(
        ...
        const sortedCats = Object.values(catStats).sort(
    ...
    fetch(`${API_BASE}/api/catalog/tutors?limit=100`)
      ...
      .then((res) => {
        ...
        if (fetchedTutors.length > 0) {
          const sortedTutors = [...fetchedTutors].sort(
  ...
  const features = [
    {
      ...
      description:
        "Access over 10,000 courses across technology, business, creative arts, personal development, and more — all curated for quality.",
    },
    {
      icon: Clock,
      title: "Learn at Your Pace",
      description:
        "No rigid schedules. Start, pause, and resume anytime with lifetime access to all enrolled courses and materials.",
    },
    {
      icon: Award,
      title: "Earn Certificates",
      description:
        "Receive industry-recognized completion certificates that strengthen your resume and validate your expertise to employers.",
    },
    {
      icon: GraduationCap,
      title: "Expert-Led Instruction",
      description:
        "Every course is created and taught by vetted professionals with proven experience in their respective industries.",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Sign up for free in under a minute. Set up your learner profile and define your learning goals.",
    },
    {
      step: "02",
      icon: Layers,
      title: "Browse & Enroll",
      description:
        "Explore our catalog of expert-curated courses. Filter by category, skill level, or instructor to find the perfect fit.",
    },
    {
      step: "03",
      icon: MonitorPlay,
      ...
      description:
        "Watch HD video lessons, complete interactive assignments, and build real-world projects at your own pace.",
    },
    {
      step: "04",
      icon: Award,
      title: "Get Certified",
      description:
        "Pass assessments and earn a professional certificate that you can share on LinkedIn and with employers.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20 py-3">
            ...
            <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
              {[
                ...
                >
                  {link.label}
                  <span
                    className={`absolute bottom-0 left-0 h-0.5 bg-purple-600 transition-all duration-300 ${activeLink === link.href ? "w-full" : "w-0 group-hover:w-full"}`}
                  />
                </a>
              ))}
            </nav>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-3 pb-4 border-t border-gray-100 pt-4 space-y-2">
              {["Home", "Courses", "Tutors", "About", "Contact"].map(
                (label) => (
                  <a
                    key={label}
      ...
      <section
        id="home"
        className="relative bg-gradient-to-br from-purple-50 via-blue-50 to-white pt-12 pb-16 lg:pt-16 lg:pb-20 overflow-hidden"
      >
        {/* Floating blobs */}
          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div className="hero-animate-text">
              ...
              <p className="text-gray-500 mb-7 leading-relaxed text-sm lg:text-base max-w-lg">
                Master new skills with expert-led courses designed for
                real-world application. From web development to data science,
                advance your career with structured, hands-on learning paths
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-sm rounded-xl p-3 flex items-center gap-3 shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Learn from 1,000+ expert instructors
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section
        ref={ctaBannerRef}
        className="scroll-reveal py-14 bg-purple-600 relative overflow-hidden"
      >
            ...
            <div className="text-white flex items-start gap-4">
              ...
              <div>
                <h3 className="text-2xl lg:text-3xl font-bold mb-2">
                  Become a Tutor on Cognon
                </h3>
                <p className="text-purple-100 text-sm max-w-xl leading-relaxed">
                  Share your expertise, inspire learners worldwide, and build a
                  sustainable income doing what you love. Join our growing
                  community of 1,000+ expert tutors and reach students in 50+
                  countries.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div ref={featTitleRef} className="scroll-reveal text-center mb-14">
            ...
            <p className="text-gray-500 text-sm max-w-lg mx-auto leading-relaxed">
              We combine world-class instruction, flexible learning, and
              industry recognition to deliver an education experience that truly
              transforms careers.
            </p>
          </div>
          <div
            ref={featGridRef}
            className="reveal-children grid sm:grid-cols-2 lg:grid-cols-4 gap-6"
          >
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div ref={statsTitleRef} className="scroll-reveal text-center mb-12">
            ...
            <p className="text-gray-400 text-sm max-w-md mx-auto">
              Numbers that reflect our commitment to delivering quality
              education and measurable outcomes for every learner.
            </p>
          </div>
          <div
            ref={statsGridRef}
            className="reveal-children-scale grid grid-cols-2 lg:grid-cols-4 gap-8"
          >
      ...
      <section className="py-20 bg-gray-50/50">
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div ref={catTitleRef} className="scroll-reveal text-center mb-10">
            <p className="text-purple-600 font-semibold mb-2 text-xs uppercase tracking-widest">
              Browse
            </p>
            ...
            <p className="text-gray-500 text-sm max-w-lg mx-auto leading-relaxed">
              Explore our most popular course categories and find the skills
          ...
          {categoriesLoading ? (
            <div className="flex overflow-x-auto gap-6 py-6 scrollbar-hide">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="flex-shrink-0 w-72 h-40 bg-white rounded-2xl p-6 border border-gray-100 shadow-sm animate-pulse"
                >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div ref={howTitleRef} className="scroll-reveal text-center mb-14">
            ...
            <p className="text-gray-500 text-sm max-w-lg mx-auto leading-relaxed">
              Getting started on Cognon is simple. Follow these four steps to
              begin your learning journey and earn your first certificate.
            </p>
          </div>
          <div
            ref={howGridRef}
            className="reveal-children grid sm:grid-cols-2 lg:grid-cols-4 gap-8"
          >
      ...
      <section id="courses" className="py-20 bg-white">
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div
            ref={coursesTitleRef}
            className="scroll-reveal flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-4"
          >
            <div>
              <p className="text-purple-600 font-semibold mb-1 text-xs uppercase tracking-widest">
                Courses
              </p>
              ...
              <p className="text-gray-550 text-sm mt-2">
                Hand-picked courses from our top-rated courses to help you build
                in-demand skills.
              </p>
            </div>
            <button
            ...
            {coursesLoading ? (
              ...
              >
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="flex-shrink-0 w-72 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100"
                    style={{ scrollSnapAlign: "start" }}
                  >
              ...
              <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
                ...
                <p className="text-gray-400 text-sm max-w-sm mx-auto">
                  Our instructors are preparing fresh content. Check back soon
                  for new courses across all categories.
                </p>
              </div>
            ) : (
              <div className="relative">
                ...
                >
                  {courses.map((course) => (
                    ...
                    >
                      ...
                      <div className="p-5">
                        {course.category && (
                          <span className="inline-block text-xs text-purple-600 font-semibold bg-purple-50 px-2.5 py-0.5 rounded-md mb-2">
                            {course.category}
                          </span>
                        )}
                        <h3 className="font-bold text-sm mt-1 mb-2 line-clamp-2 leading-snug text-gray-900">
                          {course.title}
                        </h3>
      ...
      <section id="tutors" className="py-20 bg-gray-50">
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div ref={tutorTitleRef} className="scroll-reveal text-center mb-14">
            ...
            <p className="text-gray-500 text-sm max-w-lg mx-auto leading-relaxed">
              Our tutors are experienced professionals who bring real-world
              knowledge, practical insights, and mentorship to every course they
              create.
            </p>
          </div>
          {tutorsLoading ? (
            <div className="flex overflow-x-auto gap-6 pb-4 scrollbar-hide">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="flex-shrink-0 w-64 bg-white rounded-2xl shadow-sm border border-gray-100 animate-pulse"
                >
      ...
      <section
        ref={finalCtaRef}
        className="scroll-reveal py-20 bg-gradient-to-r from-purple-600 to-indigo-600 relative overflow-hidden"
      >
        <div className="pattern-dots absolute inset-0 pointer-events-none" />
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-purple-100 text-sm leading-relaxed mb-8 max-w-xl mx-auto">
            Join 50,000+ students already learning on Cognon. Sign up for free
            today and get instant access to our extensive course library, expert
            instructors, and supportive community.
          </p>
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div ref={aboutTitleRef} className="scroll-reveal text-center mb-14">
            <p className="text-purple-600 font-semibold mb-10 text-xl uppercase tracking-widest">
              About Us
            </p>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            ...
            <p className="text-gray-500 text-sm max-w-lg mx-auto leading-relaxed">
              We are on a mission to make quality education accessible,
              affordable, and effective for every learner around the world.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div ref={aboutTextRef} className="scroll-reveal from-right">
              ...
              <p className="text-gray-600 leading-relaxed mb-5 text-sm">
                At Cognon, we believe that education should be accessible to
                everyone, everywhere. Our platform connects passionate tutors
                with eager learners, creating a vibrant community of knowledge
                sharing and growth.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6 text-sm">
                With thousands of courses across various disciplines, we empower
                individuals to pursue their passions, advance their careers, and
                achieve their goals through flexible, high-quality online
            ...
            <div
              ref={aboutMetricsRef}
              className="scroll-reveal from-left grid grid-cols-2 gap-4"
            >
      ...
      >
        ...
        <div className="max-w-[1680px] mx-auto px-6 md:px-12 xl:px-20">
          <div
            ref={footerRef}
            className="reveal-children grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12"
          >
            {/* Brand column */}
            <div className="reveal-child">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-5">
                Cognon is a modern e-learning platform empowering learners
                worldwide with quality education, expert-led courses, and
                industry-recognized certifications.
              </p>
              <div className="space-y-2.5">
                <a
                  href="mailto:support@cognon.com"
            ...
            {/* Quick Links column */}
            <div className="reveal-child">
              <h4 className="font-semibold mb-5 text-sm text-white">
                Quick Links
              </h4>
            ...
            <div className="reveal-child">
              ...
              <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                Subscribe to our newsletter for the latest courses, offers, and
                learning tips delivered to your inbox.
              </p>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} Cognon. All rights reserved.
            </p>
