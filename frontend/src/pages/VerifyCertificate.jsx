    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
      ...
      {status === "invalid" && (
        <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            ...
            does not match any record in our system. It may be invalid or
            entered incorrectly.
          </p>
          <Link
            to="/"
            className="inline-block px-5 py-2.5 rounded-xl bg-violet-700 text-white text-sm font-medium hover:bg-violet-600 transition-colors"
          >
            Go to Cognon
          </Link>
        </div>
      ...
      {status === "valid" && cert && (
        <div className="w-full max-w-3xl">
          ...
          <div
            className="w-full rounded-xl overflow-hidden shadow-xl flex"
            style={{
              aspectRatio: "842 / 595",
          ...
          >
            ...
            >
              ...
              <p
                style={{
                  color: "#1e293b",
                  fontSize: "clamp(15px,3.3vw,32px)",
                  fontWeight: 700,
                  lineHeight: 1.1,
                  marginBottom: "2%",
              ...
              <p
                style={{
                  color: "#1e293b",
                  fontSize: "clamp(10px,1.85vw,18px)",
                  fontWeight: 700,
                  lineHeight: 1.3,
                  marginBottom: "2%",
                }}
            ...
            >
              ...
              >
                ...
                <p
                  style={{
                    color: "#c4b5fd",
                    fontSize: "clamp(5px,0.68vw,6.5px)",
                    letterSpacing: "0.1em",
                    textAlign: "center",
                    marginTop: 3,
                  }}
              ...
              <div className="text-center" style={{ zIndex: 1 }}>
                ...
                <p
                  style={{
                    color: "#a78bfa",
                    fontSize: "clamp(4.5px,0.62vw,6px)",
                    marginTop: 5,
                    lineHeight: 1.5,
                  }}
                >
                  Cognon has confirmed the identity of
                  <br />
                  this learner and their completion of
                  <br />
                  this course.
                </p>
              </div>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">
            This certificate was issued by Cognon and has been independently
