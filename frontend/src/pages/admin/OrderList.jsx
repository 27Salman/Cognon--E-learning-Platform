          ...
          <tbody className="divide-y divide-gray-100">
            {loading ? (
              ...
              orders.map((order) => (
                ...
                >
                  <td className="px-5 py-3 font-mono text-xs text-purple-700 font-bold">
                    {order.orderId}
                  </td>
                  ...
                  <td className="px-5 py-3 text-gray-600">
                    <div className="space-y-1.5">
                      {order.courses?.map((item, i) => (
                        <span
                          key={i}
                          className="inline-block text-xs bg-purple-50 text-purple-600 px-2 py-0.5 rounded-full font-medium"
                        >
                  ...
                  <td className="px-5 py-3">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium capitalize ${STATUS_COLORS[order.paymentStatus]}`}
                    >
                      {order.paymentStatus}
                    </span>
                  </td>
