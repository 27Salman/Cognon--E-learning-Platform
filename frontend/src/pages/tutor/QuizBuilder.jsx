          ...
          if (draftStr) {
            try {
              ...
              const isDifferent =
                ...
                JSON.stringify(
                  parsed.questions.map(({ _id, ...rest }) => rest),
                ) !==
                  JSON.stringify(q.questions.map(({ _id, ...rest }) => rest));
    ...
    <div className="p-10 max-w-4xl mx-auto">
      ...
      <div>
        ...
        {questions.map((q, qIndex) => (
          <div
            key={qIndex}
            className="bg-white p-6 rounded-xl shadow-sm mb-4 border"
          >
                  ...
                  >
                    ...
                    <input
                      ...
                      className={`w-full bg-transparent outline-none ${
                        isCorrect
                          ? "text-green-900 placeholder-green-700/50"
                          : "text-gray-900"
                      }`}
                    />
                  </div>
