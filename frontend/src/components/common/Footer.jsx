    ...
    <footer id="contact" className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {['Browse Courses', 'Categories', 'About Us', 'Contact', 'Help Center'].map(link => (
                <li key={link}>
          ...
          {/* Col 3 — For Educators */}
          <div>
            <h3 className="text-white font-semibold text-base mb-4">For Educators</h3>
            <ul className="space-y-2.5">
              {['Become a Tutor', 'Tutor Login', 'Teaching Guide', 'Resources', 'Tutor Support'].map(link => (
                <li key={link}>
                  <a href="#" className="text-gray-400 text-sm hover:text-white transition-colors">{link}</a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <span className="text-gray-400 text-sm">123 Education Street<br />Learning City, LC 12345</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-gray-500 text-sm">© 2024 Cognon. All rights reserved.</p>
