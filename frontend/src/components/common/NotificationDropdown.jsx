            ...
            <div className="flex items-center justify-between px-5 pb-3">
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-semibold transition-all ${activeTab === 'unread'
                    ...
                    >
                        Unread
                        {unreadCount > 0 && (
                            <span className={`text-xs px-1.5 py-0.5 rounded-full font-bold ${activeTab === 'unread' ? 'bg-white text-purple-600' : 'bg-gray-300 text-gray-600'
                                }`}>
                                {unreadCount}
                            </span>
                        )}
                    ...
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-full text-sm font-semibold transition-all ${activeTab === 'all'
                                ? 'bg-purple-600 text-white'
                                : 'bg-gray-100 text-gray-500 hover:bg-gray-200'
                            }`}
                    >
                    ...
                    <div className="px-3 py-2 space-y-2">
                        {displayed.map((notif) => (
                            <div
                                ...
                                className={`rounded-xl p-4 border transition-all ${notif.actionUrl ? 'cursor-pointer' : 'cursor-default'
                                    } ${!notif.isRead
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between gap-2">
                                    <p className={`text-sm leading-snug flex-1 ${!notif.isRead ? 'font-bold text-gray-900' : 'font-medium text-gray-600'
                                        }`}>
                                        {notif.title}
                                    </p>
