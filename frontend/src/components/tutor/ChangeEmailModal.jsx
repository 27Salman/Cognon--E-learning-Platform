...
export default function ChangeEmailModal({ currentEmail, onClose, onSuccess }) {
    ...
    const validateNewEmail = (val) => {
        ...
        if (trimmed.toLowerCase() === currentEmail?.toLowerCase()) return 'This email is already in use';
        return '';
    };
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900">Change Email Address</h2>
                        ...
                        <>
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    type="email"
                                    value={newEmail}
                                    onChange={(e) => { setNewEmail(e.target.value); setEmailError(''); setError(''); }}
