...
import { BarChart3, User, BookOpen, ShoppingBag, Wallet, DollarSign, MessageSquare, LogOut } from 'lucide-react';
...
const menuItems = [
    ...
    { name: 'Orders',     path: '/tutor/orders',    icon: ShoppingBag },
    { name: 'Wallet',     path: '/tutor/wallet',    icon: Wallet },
    { name: 'Coupon',     path: '/tutor/coupon',    icon: DollarSign },
