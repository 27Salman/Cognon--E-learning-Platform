...
export default function StudentChangePasswordModal({ studentInfo, onClose }) {
    ...
    const handleSendOTP = async () => {
        ...
        try {
            await studentAPI.requestPasswordChange();
            setStep(2);
            startTimer();
        } catch (e) {
    ...
    const handleVerify = async () => {
        ...
        setLoading(true); setError('');
        try {
            await studentAPI.verifyPasswordChange(formData.newPassword, otp);
            setSuccess(true);
                ...
                <div className="p-6">
                    {success ? (
                        <div className="text-center py-4">
                            ...
                            <div className="mt-4 animate-spin w-6 h-6 border-4 border-purple-600 border-t-transparent rounded-full mx-auto"></div>
                        </div>
                    ) : step === 1 ? (
                        <>
                            <div className="mb-4">
                            ...
                            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-5">
                                <div className="flex gap-3">
                                    ...
                                    <p className="text-sm text-purple-700">An OTP will be sent to <span className="font-semibold">{studentInfo?.email}</span> to verify this change.</p>
                                </div>
                            </div>
                        ...
                        <>
                            <div className="text-center mb-5">
                                ...
                                <p className="font-semibold text-gray-900">{studentInfo?.email}</p>
                            </div>
                            <div className="mb-4">
