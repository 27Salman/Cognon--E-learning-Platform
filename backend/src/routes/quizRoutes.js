...
router.get('/course/:courseId/student', studentOnly, quizController.getStudentQuizStatus);
...
router.post('/attempts/:attemptId/submit', studentOnly, quizController.submitAttempt);
