...
exports.verifyPasswordChange = asyncHandler(async (req, res) => {
  ...
  await adminService.verifyPasswordChange(
    req.user.id,
    req.user.email,
    newPassword,
    otp,
...
exports.approveTutor = asyncHandler(async (req, res) => {
  ...
  res
    ...
    .json({ success: true, message: "Tutor approved successful", data: tutor });
});
exports.rejectTutor = asyncHandler(async (req, res) => {
  const tutor = await adminService.rejectTutor(req.params.id);
  res
    .status(HTTP_STATUS.OK)
    .json({ success: true, message: "Tutor rejected", data: tutor });
});
...
exports.getSalesReport = asyncHandler(async (req, res) => {
  ...
  const result = await adminService.getSalesReport({
    dateFrom,
    dateTo,
    groupBy,
  });
...
exports.downloadSalesReportExcel = asyncHandler(async (req, res) => {
  ...
  await salesReportService.generateSalesExcel(
