...
exports.createCourse = asyncHandler(async (req, res) => {
  ...
  res
    ...
    .json({ success: true, message: "Course created successfully", data });
});
...
exports.updateCourse = asyncHandler(async (req, res) => {
  ...
  res
    ...
    .json({ success: true, message: "Course updated successfully", data });
});
...
exports.enrollStudent = asyncHandler(async (req, res) => {
  ...
  res
    .status(HTTP_STATUS.OK)
    .json({ success: true, message: "Enrolled successfully", data });
});
